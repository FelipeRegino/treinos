...
CREATE SCHEMA IF NOT EXISTS `treinos_db` DEFAULT CHARACTER SET utf8;
...
CREATE TABLE `treinos_db`.`corredor` (
...
INSERT INTO `treinos_db`.`corredor` (`idCorredor`, `nome`, `peso`, `altura`, `nivel`) VALUES
(2, 'Bruno', 80, 1.8, 2),
(3, 'Bruno', 80, 1.8, 2),
(4, 'Bruno', 80, 1.8, 2),
(5, 'Bruno', 180, 2, 20),
...
CREATE TABLE `treinos_db`.`corrida` (
...
CREATE TABLE `treinos_db`.`treinos` (
...
--
ALTER TABLE `treinos_db`.`corredor`
...
--
ALTER TABLE `treinos_db`.`corrida`
